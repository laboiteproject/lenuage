...
urlpatterns = [
    ...
    url(r"^(?P<boite_pk>\d+)/apps/airquality/", include('laboite.apps.airquality.urls', namespace="app_airquality")),
    url(r"^(?P<boite_pk>\d+)/apps/luftdaten/", include('laboite.apps.luftdaten.urls', namespace="app_luftdaten")),
