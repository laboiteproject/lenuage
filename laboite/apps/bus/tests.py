...
DATA_OK_ONE_BUS = '''{"nhits": 3223, "parameters": {"dataset": ["tco-bus-circulation-passages-tr"], "timezone": "UTC", "rows": 2, "sort": ["-depart"], "format": "json"}, "records": [{"datasetid": "tco-bus-circulation-passages-tr", "recordid": "3d7422502a3a2479961bdcc8737b19827d471ec9", "fields": {"numerobus": 1315094584, "depart": "2017-07-22T18:03:05+00:00", "departtheorique": "2017-07-22T18:02:00+00:00", "arriveetheorique": "2017-07-22T18:02:00+00:00", "idarret": "1177", "destination": "Rennes | R\u00e9publique", "nomarret": "Beaulieu Restau U", "precision": "Applicable", "idbus": "1315094584", "idcourse": "268437493", "nomcourtligne": "64", "arrivee": "2017-07-22T18:03:05+00:00", "sens": 0, "coordonnees": [48.122317, -1.639592], "idligne": "0064"}, "geometry": {"type": "Point", "coordinates": [-1.639592, 48.122317]}, "record_timestamp": "2017-07-22T18:03:00+00:00"}]}'''
...
def test_data_ok_one_bus(app, mocker, requests_mocker, settings):
    ...
    with requests_mocker as m:
        m.get(settings.STAR_API_BASE_URL, text=DATA_OK_ONE_BUS)
        result = app.get_app_dictionary()
        assert result == expected_data
