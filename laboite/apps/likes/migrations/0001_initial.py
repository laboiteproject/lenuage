    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_name', models.CharField(max_length=96, verbose_name='Nom de la page')),
                ('likes', models.PositiveIntegerField(blank=True, null=True, verbose_name="Nombre de J'aime")),
