...
class AppLuftdaten(App):
    sensor = models.CharField(_('Identifiant du capteur Luftdaten'), help_text=_("Veuillez saisir l'identifiant de votre capteur luftdaten"), max_length=32, default=_('11034'), null=False, blank=False)
    ...
    aqi = models.PositiveSmallIntegerField(_("Qualité de l'air mesuré par votre capteur"), choices=AQI_CHOICES, default=0)
